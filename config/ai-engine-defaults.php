...
return [
    ...
    */
    'api' => [
        ...
        'middleware' => [
            ...
            'append' => $csvEnv('AI_ENGINE_API_APPEND_MIDDLEWARE'),

            // Append middleware to specific API groups only.
            'groups' => [
                'rag' => $csvEnv('AI_ENGINE_API_RAG_MIDDLEWARE'),
                'actions' => $csvEnv('AI_ENGINE_API_ACTIONS_MIDDLEWARE'),
                'modules' => $csvEnv('AI_ENGINE_API_MODULES_MIDDLEWARE'),
                'generate' => $csvEnv('AI_ENGINE_API_GENERATE_MIDDLEWARE'),
            ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The learning layer stores reusable examples, rules, and source material
    | that agents can retrieve later. SQL remains the source of truth; vector
    | stores are optional indexes for semantic retrieval.
    |
    */
    'learning' => [
        'enabled' => env('AI_ENGINE_LEARNING_ENABLED', true),
        'default_type' => env('AI_ENGINE_LEARNING_DEFAULT_TYPE', 'general'),
        'vector_store_name' => env('AI_ENGINE_LEARNING_VECTOR_STORE_NAME', 'Learned Knowledge'),
        'include_global_in_scoped_search' => env('AI_ENGINE_LEARNING_INCLUDE_GLOBAL_IN_SCOPED_SEARCH', false),
        'min_search_score' => (float) env('AI_ENGINE_LEARNING_MIN_SEARCH_SCORE', 0.0),
        'max_content_bytes' => (int) env('AI_ENGINE_LEARNING_MAX_CONTENT_BYTES', 1048576),
        ...
        'tools' => [
            'agent_ingest_enabled' => env('AI_ENGINE_LEARNING_AGENT_INGEST_ENABLED', false),
        ],
        'adapters' => [
            'file' => [
                'enabled' => env('AI_ENGINE_LEARNING_FILE_ENABLED', true),
                'disk' => env('AI_ENGINE_LEARNING_FILE_DISK'),
                'allow_local_paths' => env('AI_ENGINE_LEARNING_FILE_ALLOW_LOCAL_PATHS', false),
                'allowed_paths' => [
                    storage_path('app'),
                ],
            ],
            'getdesign' => [
                ...
                'timeout' => (int) env('GETDESIGN_TIMEOUT', 45),
    ...
    */
    'rag' => [
        ...
        'generate_answers' => env('AI_ENGINE_RAG_GENERATE_ANSWERS', false),
        'empty_context_message' => env('AI_ENGINE_RAG_EMPTY_CONTEXT_MESSAGE', "I couldn't find relevant context for that request."),
        'context_fallback_message' => env('AI_ENGINE_RAG_CONTEXT_FALLBACK_MESSAGE', 'I found relevant context, but answer generation is disabled. Retrieved context:'),
