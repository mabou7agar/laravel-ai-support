...
{
    protected $signature = 'ai:test-vector-journey
    ...
    public function handle(
        ...
        if (!$modelClass) {
            $this->info('💡 Specify a model to continue: php artisan ai:test-vector-journey "App\Models\YourModel"');
            return self::SUCCESS;
        }
    ...
    protected function displaySummary(): void
    {
        ...
        $this->line("  2. Run: php artisan ai:analyze-model \"YourModel\"");
        $this->line("  3. Run: php artisan ai:vector-index \"YourModel\" --with-relationships");
