...
class AgentServiceRegistrar
{
    public static function register($app): void
    {
        ...
        $app->singleton(\LaravelAIEngine\Services\Agent\AgentIntentUnderstandingService::class, fn ($app) => new \LaravelAIEngine\Services\Agent\AgentIntentUnderstandingService($app->make(\LaravelAIEngine\Services\AIEngineService::class), $app->make(\LaravelAIEngine\Services\Localization\LocaleResourceService::class)));
        $app->singleton(\LaravelAIEngine\Services\Agent\IntentSignalService::class, fn ($app) => new \LaravelAIEngine\Services\Agent\IntentSignalService($app->make(\LaravelAIEngine\Services\Localization\LocaleResourceService::class), $app->make(\LaravelAIEngine\Services\Agent\AgentIntentUnderstandingService::class)));
        $app->singleton(\LaravelAIEngine\Services\Agent\MessageRoutingClassifier::class, fn ($app) => new \LaravelAIEngine\Services\Agent\MessageRoutingClassifier($app->make(\LaravelAIEngine\Services\Agent\AgentIntentUnderstandingService::class)));
        ...
        $app->singleton(\LaravelAIEngine\Services\Agent\SubAgents\SubAgentConversationService::class, fn ($app) => new \LaravelAIEngine\Services\Agent\SubAgents\SubAgentConversationService($app->make(\LaravelAIEngine\Services\Agent\SubAgents\SubAgentRegistry::class), $app->make(\LaravelAIEngine\Services\Agent\ConversationContextCompactor::class)));
        ...
        $app->singleton(\LaravelAIEngine\Services\Agent\Tools\ToolRegistry::class, function () {
            ...
            if ((bool) config('ai-engine.learning.tools.agent_ingest_enabled', false) && !$registry->has('learn_source')) {
                $registry->register('learn_source', app(\LaravelAIEngine\Services\Agent\Tools\LearnSourceTool::class));
            }
        ...
        $app->singleton(\LaravelAIEngine\Services\Agent\AgentActionExecutionService::class, fn ($app) => new \LaravelAIEngine\Services\Agent\AgentActionExecutionService($app->make(\LaravelAIEngine\Services\Agent\SelectedEntityContextService::class), null, $app->make(\LaravelAIEngine\Services\Agent\AgentManifestService::class), $app->make(\LaravelAIEngine\Services\Agent\Tools\ToolRegistry::class)));
        $app->singleton(\LaravelAIEngine\Services\Agent\AgentConversationService::class, fn ($app) => new \LaravelAIEngine\Services\Agent\AgentConversationService($app->make(\LaravelAIEngine\Services\AIEngineService::class), $app->make(\LaravelAIEngine\Services\RAG\RAGExecutionRouter::class), $app->make(\LaravelAIEngine\Services\Agent\SelectedEntityContextService::class), $app->make(\LaravelAIEngine\Services\Agent\AgentSelectionService::class), null, $app->make(\LaravelAIEngine\Services\Agent\RoutingContextResolver::class), $app->make(\LaravelAIEngine\Services\Agent\Memory\ConversationMemoryRetriever::class), $app->make(\LaravelAIEngine\Services\Agent\Memory\ConversationMemoryPromptBuilder::class)));
        $app->singleton(\LaravelAIEngine\Services\Agent\AgentExecutionFacade::class, fn ($app) => new \LaravelAIEngine\Services\Agent\AgentExecutionFacade($app->make(\LaravelAIEngine\Services\Agent\AgentActionExecutionService::class), $app->make(\LaravelAIEngine\Services\Agent\AgentConversationService::class), $app->make(\LaravelAIEngine\Services\Agent\NodeSessionManager::class)));
