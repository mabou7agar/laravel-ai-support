...
class OpenRouterEngineDriver extends BaseEngineDriver
{
    ...
    protected ?OpenRouterCostOptimizer $costOptimizer = null;
    ...
    {
        $this->costOptimizer()->apply($payload, $request);
    }

    protected function costOptimizer(): OpenRouterCostOptimizer
    {
        return $this->costOptimizer ??= new OpenRouterCostOptimizer();
    }
