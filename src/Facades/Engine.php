 ...
 * @method static \LaravelAIEngine\Services\EngineProxy openai()
 * @method static \LaravelAIEngine\Services\EngineProxy anthropic()
 * @method static \LaravelAIEngine\Services\EngineProxy gemini()
 * @method static \LaravelAIEngine\Services\EngineProxy stableDiffusion()
 * @method static \LaravelAIEngine\Services\EngineProxy elevenLabs()
 * @method static \LaravelAIEngine\Services\EngineProxy falAi()
 * @method static \LaravelAIEngine\Services\EngineProxy fal()
 * @method static \LaravelAIEngine\Services\EngineProxy deepseek()
 * @method static \LaravelAIEngine\Services\EngineProxy perplexity()
 * @method static \LaravelAIEngine\Services\EngineProxy midjourney()
 * @method static \LaravelAIEngine\Services\EngineProxy azure()
 * @method static \LaravelAIEngine\Services\EngineProxy googleTts()
 * @method static \LaravelAIEngine\Services\EngineProxy serper()
 * @method static \LaravelAIEngine\Services\EngineProxy plagiarismCheck()
 * @method static \LaravelAIEngine\Services\EngineProxy unsplash()
 * @method static \LaravelAIEngine\Services\EngineProxy pexels()
 * @method static \LaravelAIEngine\Services\EngineProxy openrouter()
 * @method static \LaravelAIEngine\Services\EngineProxy ollama()
 * @method static \LaravelAIEngine\Services\EngineProxy nvidiaNim()
 * @method static \LaravelAIEngine\Services\EngineProxy cloudflareWorkersAi()
 * @method static \LaravelAIEngine\Services\EngineProxy huggingFace()
 * @method static \LaravelAIEngine\Services\EngineProxy replicate()
 * @method static \LaravelAIEngine\Services\EngineProxy comfyUi()
 ...
 * @method static \LaravelAIEngine\Services\Learning\LearningBuilder learn()
