...
3. For identifier fields, extract names, emails, phone numbers, or other identifying information
4. For array fields, extract all entries with their complete details
5. For numeric values, include them with appropriate precision
6. Use the field descriptions and types to understand what data is expected
...
- Arrays: Include all items with their properties as specified in field definitions
- Dates: Use ISO format (YYYY-MM-DD) when possible
- Numbers: Use numeric values without currency symbols or formatting
- Prices/Amounts: Extract numeric values and map to the appropriate field names
