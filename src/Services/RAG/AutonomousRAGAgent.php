...
class AutonomousRAGAgent
{
    ...
    protected AutonomousRAGExecutionService $executionService;
    protected AutonomousRAGStructuredDataService $structuredDataService;
    protected AutonomousRAGPolicy $policy;
    protected AutonomousRAGContextService $contextService;
    ...
    public function __construct(
        ...
        ?AutonomousRAGDecisionService $decisionService = null,
        ?AutonomousRAGExecutionService $executionService = null,
        ?AutonomousRAGStructuredDataService $structuredDataService = null,
        ?AutonomousRAGPolicy $policy = null,
        ...
        $this->stateService = $stateService ?? new AutonomousRAGStateService($this->policy);
        $this->decisionService = $decisionService ?? new AutonomousRAGDecisionService($ai, $this->policy);
        $this->executionService = $executionService ?? new AutonomousRAGExecutionService();
        $this->structuredDataService = $structuredDataService ?? new AutonomousRAGStructuredDataService(
            $this->stateService,
            $this->policy
        );
        $this->modelMetadata = $modelMetadata ?? new AutonomousRAGModelMetadataService(
            $this->discovery,
            $this->stateService
        );
        $this->contextService = $contextService ?? new AutonomousRAGContextService(
            $this->modelMetadata,
            $this->policy
        );
    }
