...
class RAGDecisionPromptService
{
    ...
    public function __construct(
        ...
        protected RAGDecisionFeedbackService $feedback,
        ...
        $this->promptPolicyService = $this->promptPolicyService ?? new RAGPromptPolicyService($policy);
    }
    ...
    protected function promptLimit(string $key, int $default): int
    {
        $value = function_exists('config')
            ? config("ai-engine.rag.decision.prompt_limits.{$key}", $default)
            : $default;
