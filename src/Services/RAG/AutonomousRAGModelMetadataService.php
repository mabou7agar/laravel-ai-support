...
class AutonomousRAGModelMetadataService
{
    public function __construct(
        protected ?RAGCollectionDiscovery $discovery = null,
        protected ?AutonomousRAGStateService $stateService = null,
        ...
        $this->stateService = $stateService ?? new AutonomousRAGStateService(new AutonomousRAGPolicy());
