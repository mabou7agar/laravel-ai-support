    ...
    public function run(): void
    {
        $models = [
            ...
            [
                ...
                'name' => 'GPT Image 2',
                'version' => '2',
                'description' => 'Latest GPT Image model for high-quality generation and editing',
                'capabilities' => ['image_generation', 'image_editing', 'vision'],
                'context_window' => ['input' => 400000, 'output' => null],
                'pricing' => ['unit' => 'usd_per_1k_tokens', 'input' => 0.008, 'output' => 0.03, 'image_low' => 0.006, 'image_medium' => 0.053, 'image_high' => 0.211],
                'max_tokens' => null,
                'supports_streaming' => true,
                'supports_vision' => true,
            ...
            [
                ...
                'name' => 'Claude Opus 5',
                'version' => '5',
                'description' => 'Most capable Claude Opus model for complex reasoning and agents',
                'capabilities' => ['chat', 'vision', 'coding', 'analysis', 'function_calling'],
